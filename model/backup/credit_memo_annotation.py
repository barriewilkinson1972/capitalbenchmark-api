...
ANNOTATION_SCHEMA_VERSION = "credit_memo_annotation_v0.1"
...
RATING_RE = re.compile(r"\b(?:AAA|AA\+|AA-|AA|A\+|A-|A|BBB\+|BBB-|BBB|BB\+|BB-|BB|B\+|B-|B|CCC\+|CCC-|CCC|CC|C|D)\b")
...
def _check_core_rating_and_pd(
    ...
    if expected_rating:
        mentioned_ratings = set(RATING_RE.findall(narrative_text))
